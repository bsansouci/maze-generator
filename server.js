...
function generateMaze() {
  ...
  var doors = [];
  if(!s1[1][0].north) doors.push({type: "north", x: s1[1][0].x, y: s1[1][0].y, color1: "yellow", color2: "blue"});
  if(!s1[1][2].south) doors.push({type: "south", x: s1[1][2].x, y: s1[1][2].y, color1: "yellow", color2: "blue"});
  if(!s1[2][1].east) doors.push({type: "east", x: s1[2][1].x, y: s1[2][1].y, color1: "yellow", color2: "blue"});
  if(!s1[0][1].west) doors.push({type: "west", x: s1[0][1].x, y: s1[0][1].y, color1: "yellow", color2: "blue"});

  if(!s2[1][0].north) doors.push({type: "north", x: s2[1][0].x, y: s2[1][0].y, color1: "blue", color2: "red"});
  if(!s2[1][2].south) doors.push({type: "south", x: s2[1][2].x, y: s2[1][2].y, color1: "blue", color2: "red"});
  if(!s2[2][1].east) doors.push({type: "east", x: s2[2][1].x, y: s2[2][1].y, color1: "blue", color2: "red"});
  if(!s2[0][1].west) doors.push({type: "west", x: s2[0][1].x, y: s2[0][1].y, color1: "blue", color2: "red"});

  if(!s3[1][0].north) doors.push({type: "north", x: s3[1][0].x, y: s3[1][0].y, color1: "red", color2: "green"});
  if(!s3[1][2].south) doors.push({type: "south", x: s3[1][2].x, y: s3[1][2].y, color1: "red", color2: "green"});
  if(!s3[2][1].east) doors.push({type: "east", x: s3[2][1].x, y: s3[2][1].y, color1: "red", color2: "green"});
  if(!s3[0][1].west) doors.push({type: "west", x: s3[0][1].x, y: s3[0][1].y, color1: "red", color2: "green"});
